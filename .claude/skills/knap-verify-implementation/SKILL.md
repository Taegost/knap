---
name: knap-verify-implementation
...
```
/knap-verify-implementation <plan-filename>
/knap-verify-implementation 2026-06-18-003-feat-migration-to-knap-dir-plan.md
/knap-verify-implementation
```
